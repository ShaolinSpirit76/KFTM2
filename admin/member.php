...
<?php foreach($displayUsersResult as $displayUser){?>
  <?php if ($displayUser['teacherRank'] === 'Simui'): ?>
...
<?php foreach($displayUsersResult as $displayUser){?>
  <?php if ($displayUser['teacherRank'] === 'Sisook'): ?>
...
<button type="button" id="countDeleteButton" class="badge badge-secondary btn btn-primary" data-toggle="modal" data-target="#test<?=$displayUser['ID']?>">
  Supprimer le compte
</button>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" value="<?=$displayUser['ID']?>" id="adminDeleteRequest" name="adminDeleteRequest" class="btn btn-primary">Confirmer</button>
</form>
      </div>
    </div>
  </div>
